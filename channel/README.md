...
- An aX platform account and an agent-bound token (`axp_a_...`) generated with `axctl token mint`
...
Preferred: point the channel at the agent config generated by `axctl token mint`:
